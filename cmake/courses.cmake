...
function(visitlab_generate_lecture course lecture)
    ...
    set(options SOLUTION STUDENT_FOLDER)
    set(oneValueArgs "")
    set(multiValueArgs EXTRA_FILES STUDENT_FILE)
    ...
    if(ARG_STUDENT_FOLDER)
        get_filename_component(LAST_DIR "${CMAKE_CURRENT_SOURCE_DIR}" NAME)
        set(executable_target "${course}_${LAST_DIR}")
        add_executable(${executable_target} "main.cpp" "application.cpp" ${ARG_EXTRA_FILES})
    elseif(ARG_STUDENT_FILE)
        set(executable_target "${course}_${ARG_STUDENT_FILE}")
        add_executable(${executable_target} "main.cpp" ${ARG_EXTRA_FILES} ${ARG_STUDENT_FILE})
    elseif(ARG_SOLUTION AND EXISTS "${lecture_path}/solution/solution.cpp")
        set(executable_target "${course}_${lecture}_solution")
        add_executable(${executable_target} "solution/solution.cpp" "main.cpp" ${ARG_EXTRA_FILES})
    elseif(NOT ARG_SOLUTION)
        set(executable_target "${course}_${lecture}")
        add_executable(${executable_target} "application.cpp" "main.cpp" ${ARG_EXTRA_FILES})
    else()
    ...
    if(NOT (ARG_SOLUTION OR ARG_STUDENT))
        ...
        file(GENERATE
            ...
            CONTENT "
modules_dir = \"${CMAKE_SOURCE_DIR}/modules/\" 
