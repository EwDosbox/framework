...
// Constructors
// ----------------------------------------------------------------------------
IApplication::IApplication(int initial_width, int initial_height, std::vector<std::string> arguments) : width(initial_width), height(initial_height), arguments(arguments), configuration(Configuration(arguments[0]))
{
	framework_folder_path = configuration.get_path("modules_dir", "/framework");
...
// Getters & Setters
// ----------------------------------------------------------------------------
size_t IApplication::get_width() const
{
	return this->width;
}

size_t IApplication::get_height() const
{
	return this->height;
}

std::filesystem::path IApplication::get_framework_folder_path() const
{
	return this->framework_folder_path;
}

void IApplication::set_window(GLFWwindow* window)
{
	this->window = window;
}
